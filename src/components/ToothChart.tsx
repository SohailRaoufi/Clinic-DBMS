import "./styles/Tooth.module.css";
import React from "react";

interface ToothCharProps {
  selectTeethFunction: any;
  teethIsSelected: any;
  teethStyle: any;
}

const ToothChart: React.FC<ToothCharProps> = ({
  selectTeethFunction,
  teethIsSelected,
  teethStyle,
}) => {
  return (
    <div className={`tooth_chart  md:ml-8 xl:mx-auto ${teethStyle}`}>
      <svg
        version="1.1"
        ...
        xmlSpace="preserve"
      >
        <g id="toothLabels" className="toothLabels">
          <text
            id="lbl32"
